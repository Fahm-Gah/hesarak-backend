...
export const metadata: Metadata = {
  title: 'سیاست حریم خصوصی | حصارک پنجشیر - حفاظت از اطلاعات شما',
  description:
    'بیاموزید که حصارک پنجشیر چگونه از اطلاعات شخصی شما محافظت می‌کند و اطلاعات شما را با شفافیت و امنیت مدیریت می‌کند.',
}
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <ul className="list-disc list-inside space-y-1 mr-4">
                    ...
                    <li>
                      <strong>ایمنی و امنیت:</strong> برای محافظت از حقوق، دارایی، یا ایمنی حصارک
                      پنجشیر، کاربران ما، یا سایرین
                    </li>
                    <li>
              ...
              <div>
                ...
                <div className="space-y-2 text-gray-700">
                  ...
                  <ul className="list-disc list-inside space-y-1 mr-4">
                    ...
                    <li>تاریخ &ldquo;آخرین تغییر&rdquo; را بروزرسانی خواهیم کرد</li>
