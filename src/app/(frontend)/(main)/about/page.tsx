...
export const metadata: Metadata = {
  ...
  description:
    'در مورد ماموریت حصارک پنجشیر برای ارائه سفر امن، راحت و قابل اعتماد بس در سراسر افغانستان بیاموزید. داستان، ارزش‌ها و تعهد ما به ایمنی مسافران را کشف کنید.',
}
  ...
  const values = [
    {
      ...
      description:
        'ایمنی مسافران اولویت اصلی ما است. همه بس‌های ما تحت تعمیرات منظم و بازرسی‌های ایمنی قرار می‌گیرند.',
    },
    {
      icon: Users,
    ...
    },
    {
      icon: Award,
      title: 'خدمات باکیفیت',
      description: 'متعهد به حفظ استانداردهای بالای خدمات با بس‌های راحت و رانندگان حرفه‌ای.',
    },
  ]
  ...
  const milestones = [
    {
      ...
      description:
        'با چشم‌اندازی برای انقلاب در سفرهای بس در افغانستان با فناوری مدرن و رویکرد مشتری محور آغاز شد.',
    },
    {
      year: '۱۳۹۱',
    ...
    },
    {
      ...
      title: 'توسعه ناوگان',
      description:
        'ناوگان خود را با بس‌های مدرن مجهز به ویژگی‌های ایمنی و امکانات راحتی مسافران گسترش داد.',
    },
    {
      year: '۱۴۰۵',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              ما متعهد به ارائه خدمات سفر امن، راحت و قابل اعتماد بس در سراسر افغانستان هستیم و مردم
              و جوامع را با راه‌حل‌های حمل و نقل مدرن متصل می‌کنیم.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                تغییر سفرهای بس در افغانستان از طریق ارائه خدمات ترانسپورتی امن، راحت و مقرون به
