    ...
    const performLogout = async () => {
      ...
      try {
        ...
        if (result.success) {
          ...
          setLocalError(result.error || 'خروج ناموفق بود. لطفاً دوباره تلاش کنید.')
        }
      } catch (err) {
        console.error('Logout error:', err)
        setLocalError('خطای شبکه. لطفاً دوباره تلاش کنید.')
      }
    }
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-8 text-center">
          ...
          {isLoading ? (
            <>
              ...
              <h2 className="text-xl font-semibold text-gray-800 mb-2">در حال خروج...</h2>
              <p className="text-gray-600">
                لطفاً منتظر بمانید تا به طور ایمن از حسابتان خارج شوید.
              </p>
            </>
          ) : localError ? (
            <>
              ...
              <h2 className="text-xl font-semibold text-gray-800 mb-2">خروج ناموفق</h2>
            ...
            <>
              ...
              <h2 className="text-xl font-semibold text-gray-800 mb-2">با موفقیت خارج شدید</h2>
              <p className="text-gray-600 mb-6">
                به طور ایمن خارج شدید. در حال انتقال به صفحه اصلی...
              </p>
            </>
          ) : null}
