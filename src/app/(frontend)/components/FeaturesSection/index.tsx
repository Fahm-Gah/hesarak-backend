  ...
  const features = [
    {
      ...
      title: 'امن و مطمئن',
      description:
        'تمام بس‌های ما به طور منظم نگهداری و بازرسی می‌شوند تا ایمنی و راحتی شما تضمین شود.',
    },
    {
      icon: Clock,
      title: 'خدمات ۲۴ ساعته',
      description: 'خدمات مشتریان و خدمات بسرانی شبانه‌روزی مطابق با برنامه شما.',
    },
    {
      icon: MapPin,
      title: 'پوشش گسترده',
    ...
    },
    {
      icon: Star,
      title: 'خدمات باکیفیت',
      description: 'بس‌های با کیفیت ممتاز با چوکی‌های راحت و امکانات مدرن.',
    },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            بهترین تجربه سفر با بس را با تعهد ما به ایمنی، راحتی و قابلیت اعتماد تجربه کنید
          </p>
        </div>
