...
export const HeroSection = () => {
  return (
    <section
      className="relative min-h-[600px] md:min-h-[700px] xl:min-h-[calc(100vh-4rem)] xl:h-[calc(100vh-4rem)] flex flex-col overflow-visible"
      dir="rtl"
    >
      ...
      <div className="relative z-10 flex flex-col flex-1">
        {/* Hero content */}
        <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-10 lg:py-12 xl:py-8">
          <div className="max-w-7xl mx-auto w-full">
            {/* Main heading and description */}
            <div className="text-center mb-6 sm:mb-8 md:mb-10 lg:mb-8 xl:mb-10">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-black text-white mb-3 sm:mb-4 md:mb-4 lg:mb-5 xl:mb-6 tracking-tight leading-[1.1]">
            ...
            {/* Search form */}
            <div className="w-full max-w-6xl mx-auto mb-6 sm:mb-8 md:mb-8 lg:mb-6 xl:mb-10 relative z-20 overflow-visible">
              <TripSearchForm />
            </div>

            {/* Trust indicators */}
            <div className="grid grid-cols-3 gap-4 sm:gap-6 md:gap-6 lg:gap-8 max-w-4xl mx-auto text-center">
              <div className="flex flex-col">
                <div className="text-xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-4xl font-black text-orange-400 mb-1 sm:mb-2">
                  ۱۰,۰۰۰+
                </div>
