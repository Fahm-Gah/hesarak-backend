...
export const TestimonialsSection = () => {
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      comment:
        'برای کار مکرراً سفر می‌کنم و حصارک پنجشیر انتخاب اول من شده است. اتوبوس‌های تمیز، رانندگان حرفه‌ای و خدمات عالی مشتری.',
      route: 'هرات به کابل',
    },
    {
      name: 'محمد علی',
    ...
    },
    {
      ...
      rating: 5,
      comment:
        'خدمات حرفه‌ای و مهربان. رانندگان باتجربه و اتوبوس‌ها خوب نگهداری می‌شوند. احساس امنیت با حصارک پنجشیر.',
